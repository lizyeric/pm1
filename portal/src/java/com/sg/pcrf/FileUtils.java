...
public class FileUtils {
	...
	public static void writeToFile(String name, byte[] content) throws IOException {
    ...
    public static String readContent(String filename) throws IOException {
        ...
        char[] buf = new char[6500];
        int actual = 0;
        StringBuilder sb = new StringBuilder();
        while ((actual = reader.read(buf, 0, buf.length)) > 0) {
            sb.append(buf, 0, actual);
        }
        reader.close();
        return sb.toString();
    }
